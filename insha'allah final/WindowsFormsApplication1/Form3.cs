...
namespace WindowsFormsApplication1
{
    public partial class Form3 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e) //viewing trips of driver
        {
            trips.Visible = true;
        ...
        Requests k; //so to be seen by the whole form
        private void button1_Click(object sender, EventArgs e) //on accepting requests
        {
        ...
        private void button5_Click(object sender, EventArgs e) //available
        {
            for (int i = 0; i < Form0.loadData.List_Driver.Count; i++)
            {
        ...
        private void button6_Click(object sender, EventArgs e) //busy
        {
            for (int i = 0; i < Form0.loadData.List_Driver.Count; i++)
            {
                if (Form5.idD == Form0.loadData.List_Driver[i].getDriverId())
        ...
        private void button2_Click_2(object sender, EventArgs e) //end of trip
        {
            ride.Visible = false;
            watch.Stop();
           ...
           if( p<0)
            ...
            Trips td = new Trips(k.get_id(), k.get_pickup(), k.get_dropoff(), s, p); //adding the trip
