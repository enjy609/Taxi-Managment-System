...
namespace WindowsFormsApplication1
{
    public partial class Form6 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Form0.loadData.List_Client.Count; i++) //viewing all history by admin
            {
                if (Form0.loadData.client_Trips.ContainsKey(Form0.loadData.List_Client[i].get_id()) == true)
                {
                    ...
                    {
                        for (int k = 0; k < Form0.loadData.List_Driver.Count; k++) //three loops as we need the driver's name and client's name
                        {
